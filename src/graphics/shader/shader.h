...
// Magnus iOS stats (ported from MagnusPS5, Kyty Sep-20 base).
// Counters are updated in shader.cpp RecordShaderCompile(); read via
// magnus_stats() in src/ios/embed.cpp for A19 Pro perf HUD.
